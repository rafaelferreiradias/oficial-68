-- Full data backup restoration with all user data, rankings, and complete dataset
...
('d4e5f6g7-8901-bcde-f234-56789abcdef0', 'd4e5f6g7-8901-bcde-f234-56789abcdef0', 'Pedro Oliveira', 'pedro@teste.com', 'client', '+5511955554444', '1995-12-03', 'masculino', 172, '2025-07-13 04:20:33.567890+00', '2025-07-15 21:15:44.012345+00'),
('e5f6g7h8-9012-cdef-3456-789abcdef012', 'e5f6g7h8-9012-cdef-3456-789abcdef012', 'Lucia Ferreira', 'lucia@teste.com', 'client', '+5511944443333', '1991-09-17', 'feminino', 162, '2025-07-13 05:35:27.890123+00', '2025-07-15 22:00:55.345678+00')
...
('points-d4e5f6g7-8901-bcde-f234-56789abcdef0', 'd4e5f6g7-8901-bcde-f234-56789abcdef0', 1654, 68, 476, 1654, 7, 14, 4, '2025-07-15', '2025-07-13 04:20:33.567890+00', '2025-07-15 22:45:55.345678+00'),
('points-e5f6g7h8-9012-cdef-3456-789abcdef012', 'e5f6g7h8-9012-cdef-3456-789abcdef012', 1422, 61, 427, 1422, 6, 10, 3, '2025-07-15', '2025-07-13 05:35:27.890123+00', '2025-07-15 22:30:12.456789+00')
ON CONFLICT (id) DO UPDATE SET
...
('fisicos-d4e5f6g7-8901-bcde-f234-56789abcdef0', 'd4e5f6g7-8901-bcde-f234-56789abcdef0', 'Pedro Oliveira', '1995-12-03', 'masculino', 172, 72.8, 68.0, 88, 24.6, 'Normal', 'Baixo', '2025-07-13 04:20:33.567890+00', '2025-07-15 21:30:33.567890+00'),
('fisicos-e5f6g7h8-9012-cdef-3456-789abcdef012', 'e5f6g7h8-9012-cdef-3456-789abcdef012', 'Lucia Ferreira', '1991-09-17', 'feminino', 162, 59.6, 55.0, 75, 22.7, 'Normal', 'Baixo', '2025-07-13 05:35:27.890123+00', '2025-07-15 22:15:27.890123+00')
ON CONFLICT (id) DO UPDATE SET
...
('missao-d4e5f6g7-2025-07-15', 'd4e5f6g7-8901-bcde-f234-56789abcdef0', '2025-07-15', 'Água com hortelã', 8, 'Alongamento matinal', 8, '2.3L', true, 2, false, 'Saúde em dia', 'Estudei novo idioma', 'Manter exercícios', 9, true, '2025-07-15 05:30:00+00', '2025-07-15 22:30:00+00'),
('missao-e5f6g7h8-2025-07-15', 'e5f6g7h8-9012-cdef-3456-789abcdef012', '2025-07-15', 'Chá de camomila', 6, 'Meditação guiada', 7, '2.1L', false, 5, true, 'Pets carinhosos', 'Terminei projeto', 'Relaxar mais', 6, false, '2025-07-15 07:15:00+00', '2025-07-15 20:15:00+00')
ON CONFLICT (id) DO UPDATE SET
...
('pesagem-d4e5f6g7-2025-07-15', 'd4e5f6g7-8901-bcde-f234-56789abcdef0', 72.8, 59.3, 16.8, 6, 30.1, 3.0, 1580, 'Atlético', 'Balança Inteligente', '2025-07-15 12:00:00+00', '2025-07-15 12:00:00+00', '2025-07-15 12:00:00+00'),
('pesagem-e5f6g7h8-2025-07-15', 'e5f6g7h8-9012-cdef-3456-789abcdef012', 59.6, 63.7, 19.5, 5, 24.9, 2.3, 1280, 'Normal', 'Balança Manual', '2025-07-15 13:00:00+00', '2025-07-15 13:00:00+00', '2025-07-15 13:00:00+00')
ON CONFLICT (id) DO NOTHING;
...
('saude-d4e5f6g7-8901-bcde-f234-56789abcdef0', 'd4e5f6g7-8901-bcde-f234-56789abcdef0', 172, 72.8, 68.0, 88, 24.6, 58.3, '2025-07-15 21:30:33+00', '2025-07-13 04:20:33+00'),
('saude-e5f6g7h8-9012-cdef-3456-789abcdef012', 'e5f6g7h8-9012-cdef-3456-789abcdef012', 162, 59.6, 55.0, 75, 22.7, 78.3, '2025-07-15 22:15:27+00', '2025-07-13 05:35:27+00')
ON CONFLICT (id) DO UPDATE SET
altura_cm = EXCLUDED.altura_cm,
peso_atual_kg = EXCLUDED.peso_atual_kg,
meta_peso_kg = EXCLUDED.meta_peso_kg,
...
('info-d4e5f6g7-8901-bcde-f234-56789abcdef0', 'd4e5f6g7-8901-bcde-f234-56789abcdef0', '1995-12-03', 'masculino', 172, 72.8, 68.0, 88, 24.6, '2025-07-13 04:20:33+00', '2025-07-15 21:30:33+00'),
('info-e5f6g7h8-9012-cdef-3456-789abcdef012', 'e5f6g7h8-9012-cdef-3456-789abcdef012', '1991-09-17', 'feminino', 162, 59.6, 55.0, 75, 22.7, '2025-07-13 05:35:27+00', '2025-07-15 22:15:27+00')
ON CONFLICT (id) DO UPDATE SET
peso_atual_kg = EXCLUDED.peso_atual_kg,
meta_peso_kg = EXCLUDED.meta_peso_kg,
circunferencia_abdominal_cm = EXCLUDED.circunferencia_abdominal_cm,
...
('perfil-d4e5f6g7-8901-bcde-f234-56789abcdef0', 'd4e5f6g7-8901-bcde-f234-56789abcdef0', 'Performance esportiva', 'Segunda tentativa', 'Lesão', 'Bom apoio', 3, 9, 'Focado', 'Pela recuperação', '2025-07-13 04:20:33+00', '2025-07-15 21:30:33+00'),
('perfil-e5f6g7h8-9012-cdef-3456-789abcdef012', 'e5f6g7h8-9012-cdef-3456-789abcdef012', 'Bem-estar geral', 'Primeira tentativa', null, 'Médio apoio', 8, 5, 'Ansiosa', 'Pelos pets', '2025-07-13 05:35:27+00', '2025-07-15 22:15:27+00')
ON CONFLICT (id) DO UPDATE SET
